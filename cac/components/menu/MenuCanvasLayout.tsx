...
export function MenuCanvasLayout({ activeCategory }: MenuCanvasLayoutProps) {
    ...
    // Default to coffee theme for all Categories
    const theme = { softBg: "hsl(25, 30%, 96%)" };
            ...
            <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6 pb-24 pt-4 md:flex-row md:items-start md:px-10">
                ...
                <div className="relative flex-1 space-y-6">
                    <div className="space-y-2">
                        <p className="text-[11px] uppercase tracking-[0.24em] text-coffee-800/60">
                            {CATEGORY_LABELS[activeCategory]}
                        </p>
                        <h2 className="text-xl font-semibold tracking-tight text-coffee-900">
                            {featured ? featured.name : "From the kitchen"}
                        </h2>
                        <p className="max-w-md text-sm text-coffee-800/80">
                            {featured
                                ? featured.shortDesc
                        ...
                        {featured && (
                            <motion.div
                                ...
                                style={{
                                    ...
                                    boxShadow:
                                        "0 25px 60px rgba(111, 55, 15, 0.18), 0 0 0 1px rgba(111, 55, 15, 0.04)",
                                }}
                            >
                                <motion.img
                    ...
                    <p className="text-[11px] text-coffee-800/60">
                ...
                <div className="flex-1 space-y-3">
                    <div className="flex items-center justify-between">
                        <p className="text-xs font-medium uppercase tracking-[0.24em] text-coffee-800/50">
                            Items on this section
                        </p>
                        <span className="text-[11px] text-coffee-800/50">
                            {items.length} options
                        </span>
                    </div>

                    <div className="h-px w-full bg-gradient-to-r from-transparent via-coffee-200/50 to-transparent" />
    ...
    return (
        <div className="space-y-1">
            <div className="flex items-baseline justify-between gap-4">
                <p className="text-sm font-medium tracking-[0.03em] text-coffee-900">
                    {name}
                </p>
                <span className="flex-shrink-0 text-sm font-semibold text-coffee-900">
                    ₹{price}
                </span>
            </div>
            <p className="text-[11px] leading-snug text-coffee-800/70">{desc}</p>
        </div>
    );
}
    ...
    return (
        <motion.div
            ...
            style={{
                ...
                boxShadow:
                    "0 22px 60px rgba(111, 55, 15, 0.18), 0 0 0 1px rgba(111, 55, 15, 0.03)",
            }}
