...
export function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-black/5 bg-white/70 backdrop-blur-md">
      ...
      <aside
        className={`fixed right-0 top-0 z-50 flex h-full w-64 flex-col border-l border-black/5 bg-white/60 backdrop-blur-xl px-4 py-4 text-sm font-medium text-gray-700 shadow-xl transition-transform duration-200 md:hidden ${
